...
wofi_command = f"echo '{output}' | wofi --show=dmenu --hide-scroll --allow-markup --prompt='WirePlumber Sinks'"  # --define=hide_search=true
...
# print(selected_sink)
result = subprocess.run(f"wpctl set-default {selected_sink['sink_id']}", shell=True)
print(result.stdout)
