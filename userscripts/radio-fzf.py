...
def fzf_station_select(file_path):
    ...
    try:
        result = sp.Popen(["fzf"], stdin=cmd_out.stdout, stdout=sp.PIPE, text=True)
...
def main():
    file_path = '/home/joel/.config/userscripts/radio-stations.csv'  # Update with your CSV file path
