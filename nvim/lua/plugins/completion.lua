return {
  -- blink.cmp alternative to nvim-cmp
  {
    ...
    opts = {
      ...
      sources = {
        default = { "lsp", "path", "buffer", "snippets", "nerdfont" },
        providers = {
          buffer = {
            name = "Buffer",
        ...
        sources = cmp.config.sources({
          ...
          { name = "papis" },
          {
            ...
            option = {
              ...
              loud = true,
              dict = "/usr/share/dict/english.txt", -- list from kkrypt0nn/wordlists
              -- dict = "/usr/share/dict/english.txt", -- list from berzerk0/Probable-Wordlists
              dflag = true,
