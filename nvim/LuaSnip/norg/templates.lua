...
local gym = function(args, snip)
  ...
  if day == "leg" then
    table.insert(nodes, t({ "  Barbell Squats        - 8x135lb + 6x155lb + 6x155lb + 8x135lb", "" }))
    table.insert(nodes, t({ "  Hamstring Curls       - 8x25lb + 8x30lb + 6x30lb + 6x30lb", "" }))
    table.insert(nodes, t({ "  Romanian Split Squats - 8x90lb + 8x90lb + 8x90lb + 8x90lb", "" }))
    table.insert(nodes, t({ "  Calf Raise            - 8x190lb + 8x190lb + 8x190lb + 8x190lb", "" }))
    -- table.insert(nodes, t({ "  Leg Press             - 6x40lb + 6x50lb + 8x50lb + 6x60lb", "" }))
  elseif day == "push" then
    table.insert(nodes, t({ "  Bench Press                 - 8x85lb + 4x95lb + 3x95lb + 6x85lb", "" }))
    table.insert(nodes, t({ "  Bumbell Incline Bench Press - 8x25lb + 6x25lb + 8x20lb + 8x20lb", "" }))
    table.insert(nodes, t({ "  Shoulder Press              - 8x30lb + 6x30lb + 6x30lb + 4x7.5lb", "" }))
    table.insert(nodes, t({ "  Cable Chest Press           - 8x10lb + 4x20lb + 10x15lb + 7x15lb", "" }))
    table.insert(nodes, t({ "  Tricep Push Down            - 12x15lb + 9x20lb + 7x20lb + 6x20lb", "" }))
    table.insert(nodes, t({ "  Pectoral Fly                - 8x20lb + 8x25lb + 6x30lb", "" }))
  elseif day == "pull" then
    table.insert(nodes, t({ "  Curlbar Deadlift - 6x7.5lb + 6x10lb + 8x10lb + 6x15lb", "" }))
    table.insert(nodes, t({ "  Lat Pulldown     - 6x20lb + 6x25lb + 8x25lb + 6x30lb", "" }))
    table.insert(nodes, t({ "  Face Pulls       - 6x10lb + 6x15lb + 8x15lb + 6x20lb", "" }))
    table.insert(nodes, t({ "  Bicep Curls      - 6x0lb + 6x2.5lb + 8x5lb + 6x5lb", "" }))
  end
